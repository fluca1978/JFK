...
public @interface Connect {
    ...
    /**
     * The name of the delegate to which this method will be connected to.
     * @return the name used to identify the delegate abstract method (must match the name
     * in the @Delegate annotation)
     */
