...
/**
 * This is a tagging interface used only to differentiate a closure from a pure function, but there is no
 * techincal difference between the two interfaces.
 * 
 * @author Luca Ferrari - fluca1978 (at) gmail.com
 *
 */
public interface IClosure extends IFunction {
