...
/**
 * A bad event consumer, does not have the right annotations.
 * @author Luca Ferrari - fluca1978 (at) gmail.com
 *
 */
public class BadEventConsumer implements IDelegate{

    public void consume(String s){
	System.out.println("Consuming the bad event " + s);
    }
}
